...
function postBuilding() { 
	...
	$username = $_SESSION['username'];
	$query = pg_query("SET search_path TO synergy; INSERT INTO building(n_id,address,city,country,capacity,worknumber) VALUES ('$network','$address','$city','$country',$capacity,'$username')")
